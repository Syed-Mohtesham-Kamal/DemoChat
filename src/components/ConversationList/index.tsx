...
export default function ConversationList(props: ConversationListProps) {
  ...
  return (
    <div 
      className="flex items-center w-full h-[4.5rem] bg-[#a9a9a9] pl-3 pr-4 hover:bg-[#98AFC7] cursor-pointer"
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex py-2">
          <div className="flex flex-col w-full h-full ">
            ...
            <span className="overflow-y-hidden text-ellipsis text-[#ffffff] text-sm">{lastMessage}</span>
          </div>
          <div className="flex flex-col w-auto text-[#ffffff]">
